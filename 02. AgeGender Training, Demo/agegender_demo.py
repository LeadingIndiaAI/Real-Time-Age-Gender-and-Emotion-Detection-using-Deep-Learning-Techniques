...
def main(argv):
	...
	model_age = load_model(MODEL_ROOT_PATH+'agegender_age101_squeezenet_.hdf5')
	model_gender = load_model(MODEL_ROOT_PATH+'agegender_gender_squeezenet_.hdf5')
	if(os.path.exists(MODEL_ROOT_PATH+'fer2013_mini_XCEPTION.99-0.65.hdf5')):
		model_emotion = load_model(MODEL_ROOT_PATH+'fer2013_mini_XCEPTION.99-0.65.hdf5')
	else:
		model_emotion = None
